...
describe("sma", () => {
  test("should calculate the 21 period simple moving average by default", () => {
    // console.log(data)
  ...
  test("should calculate the 13 period simple moving average", () => {
  ...
  test("should calculate the 34 period simple moving average", () => {
